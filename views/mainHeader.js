            ...
            <div class="container header-grid-container">
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    ...
                    <ul class="navbar-nav mx-xl-auto align-items-xl-center gap-xl-3">
                        ...
                        <li class="nav-item mt-2 mt-xl-0 position-relative header-search-item" style="z-index: 1050;">
                            <form class="position-relative search-form-header" onsubmit="return false;">
                                ...
                                <input type="search" id="headerSearchInput" class="form-control search-bar-header py-2 bg-light border-0 rounded-pill ps-5 w-100" placeholder="O que deseja aprender?" autocomplete="off">
                    ...
                    <div class="header-right-zone d-flex flex-column flex-xl-row align-items-xl-center mt-3 mt-xl-0 gap-3">
                        ...
                        ${usuarioLogado ? `
                            <div class="d-flex flex-column flex-xl-row align-items-xl-center ms-xl-2 border-top border-xl-0 pt-3 pt-xl-0 mt-2 mt-xl-0">
                                <div class="d-flex align-items-center mb-3 mb-xl-0 me-xl-3 text-dark">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="/logout" class="btn btn-outline-danger btn-sm fw-bold px-3 rounded-pill text-nowrap">Sair</a>
                                </div>
                            </div>
                        ` : `
                            <div class="d-flex gap-2 w-100 mt-2 mt-xl-0">
                                <a href="/login?returnTo=/" class="btn btn-outline-dark fw-bold px-4 rounded-pill flex-grow-1 flex-xl-grow-0 text-nowrap">Entrar</a>
                                <a href="/cadastro" class="btn btn-primary fw-bold px-4 rounded-pill flex-grow-1 flex-xl-grow-0 text-nowrap">Criar Conta</a>
                            </div>
                        `}
                    </div>
                </div>
