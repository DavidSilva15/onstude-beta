...
function renderNovoUsuarioView(admin, cursosDisponiveis) {
    ...
    // CORREÇÃO: Passar 'usuarios' para ativar o botão correto no menu lateral
    const htmlSidebar = renderAdminMenuLateral(admin, 'usuarios');

    // Lógica inteligente para as opções de tipo de usuário
    let htmlTipoOpcoes = '';
    if (admin.tipo === 'ADMIN') {
        htmlTipoOpcoes = `
    ...
    <body class="bg-light">
        ...
        <script>
            // Script simples para esconder a secção de matrícula se o tipo for ADMIN ou MENTOR
