...
function renderCadastroView(erro = null) {
    // Se houver um erro (ex: e-mail já registado), mostramos um alerta do Bootstrap
    ...
    <h5 class="mt-3 text-secondary fw-bold">Carregando...</h5>
        ...
        <div class="card shadow p-4" style="width: 100%; max-width: 500px;">
            <div class="text-center mb-4">
                ...
                <p class="text-muted">Crie a sua conta de aluno</p>
            </div>
            ...
            <form action="/cadastro" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" placeholder="O seu nome completo" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="senha" name="senha" placeholder="Crie uma palavra-passe forte" required>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="cidade" name="cidade" placeholder="Ex: Camaçari" required>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="text-center mt-3">
                <small>Já tem uma conta? <a href="/" class="text-decoration-none">Faça login aqui</a>.</small>
            </div>
        </div>
